...
<!-- <center>
	<a href="Category" style="font-size:25px; color:green">Category</a> | 
	<a href="Supplier" style="font-size:25px; color:green">Supplier</a> | 
	<a href="Product" style="font-size:25px; color:green">Product</a>
</center>
 -->
